...
using UnityEngine;
using VRFly.Utilities;

namespace GameEngine.Utils.StateMachineBehavior.Editor
{
    ...
    public class MessageBehaviorsEd : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical(MalbersEditor.StyleGray);
            {
                ...
                EditorGUILayout.EndVertical();
                MMessage.UseSendMessage = EditorGUILayout.Toggle(
                    new GUIContent("Use Send Message", "Uses the SendMessage() instead"), MMessage.UseSendMessage);
            }
        ...
        void HeaderCallbackDelegate1(Rect rect)
        {
            ...
            Rect R_3 = new Rect(rect.x + 10 + ((rect.width) / 3) + 5 + 30, rect.y, ((rect.width) / 3) - 5 - 15,
                EditorGUIUtility.singleLineHeight);
            EditorGUI.LabelField(R_3, "Type");

            Rect R_5 = new Rect(rect.x + 10 + ((rect.width) / 3) * 2 + 5 + 15, rect.y, ((rect.width) / 3) - 5 - 15,
                EditorGUIUtility.singleLineHeight);
        ...
        void HeaderCallbackDelegate2(Rect rect)
        {
            ...
            Rect R_3 = new Rect(rect.x + 10 + ((rect.width) / 4) + 5 + 30, rect.y, ((rect.width) / 4) - 5 - 15,
                EditorGUIUtility.singleLineHeight);
            EditorGUI.LabelField(R_3, "Type");
            Rect R_4 = new Rect(rect.x + 10 + ((rect.width) / 4) * 2 + 5 + 20, rect.y, ((rect.width) / 4) - 5,
                EditorGUIUtility.singleLineHeight);

            EditorGUI.LabelField(R_4, "Time");
            Rect R_5 = new Rect(rect.x + ((rect.width) / 4) * 3 + 5 + 10, rect.y, ((rect.width) / 4) - 5,
                EditorGUIUtility.singleLineHeight);
            EditorGUI.LabelField(R_5, "Value");
        }
        ...
        void drawElementCallback1(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            Rect R_3 = new Rect(rect.x + ((rect.width) / 3) + 5 + 30, rect.y, ((rect.width) / 3) - 5 - 15,
                EditorGUIUtility.singleLineHeight);
            element.typeM = (TypeMessage)EditorGUI.EnumPopup(R_3, element.typeM);

            Rect R_5 = new Rect(rect.x + ((rect.width) / 3) * 2 + 5 + 15, rect.y, ((rect.width) / 3) - 5 - 15,
                EditorGUIUtility.singleLineHeight);
            switch (element.typeM)
            {
                case TypeMessage.Bool:
                    element.boolValue =
                        EditorGUI.ToggleLeft(R_5, element.boolValue ? " True" : " False", element.boolValue);
                    break;
        ...
        void drawElementCallback3(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            Rect R_3 = new Rect(rect.x + ((rect.width) / 4) + 5 + 30, rect.y, ((rect.width) / 4) - 5 - 5,
                EditorGUIUtility.singleLineHeight);
            element.typeM = (TypeMessage)EditorGUI.EnumPopup(R_3, element.typeM);

            Rect R_4 = new Rect(rect.x + ((rect.width) / 4) * 2 + 5 + 25, rect.y, ((rect.width) / 4) - 5 - 15,
                EditorGUIUtility.singleLineHeight);
            ...
            Rect R_5 = new Rect(rect.x + ((rect.width) / 4) * 3 + 15, rect.y, ((rect.width) / 4) - 15,
                EditorGUIUtility.singleLineHeight);
            switch (element.typeM)
            {
                case TypeMessage.Bool:
