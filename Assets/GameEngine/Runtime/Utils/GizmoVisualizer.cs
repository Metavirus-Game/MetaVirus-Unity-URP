...
namespace GameEngine.Utils
{
    public class GizmoVisualizer : MonoBehaviour
    {
        ...
        [Range(0, 1f)] public float alpha = 1;
        ...
        void OnDrawGizmos()
        {
            if (DrawAxis)
            {
                ...
                UnityEditor.Handles.ArrowHandleCap(0, transform.position, transform.rotation, AxisSize,
                    EventType.Repaint);
        ...
        void UsesColliders(bool sel)
        {
            if (_Collider is BoxCollider)
            {
                ...
                Matrix4x4 rotationMatrix =
                    Matrix4x4.TRS(_C.bounds.center, transform.rotation, new Vector3(sizeX, sizeY, sizeZ));
