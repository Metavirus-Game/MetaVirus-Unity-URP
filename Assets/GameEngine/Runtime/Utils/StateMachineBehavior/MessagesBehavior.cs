...
namespace GameEngine.Utils.StateMachineBehavior
{
    ...
    public class MessagesBehavior : StateMachineBehaviour
    {
        ...
        /// </summary>
        void DeliverMessage(MessageItem m, Animator anim)
        {
            switch (m.typeM)
            {
        ...
        /// </summary>
        void DeliverListener(MessageItem m, IAnimatorListener listener)
        {
            switch (m.typeM)
            {
                case TypeMessage.Bool:
