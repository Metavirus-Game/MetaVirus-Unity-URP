...
using MetaVirus.Logic.Procedures.BattleTest;
...
{
    [Procedure]
    public class EnterMonsterTestProcedure : ProcedureBase
    {
        ...
        public override void OnEnter(FsmEntity<ProcedureService> fsm)
        {
            ...
            //切换到战斗地图
            ChangeMapProcedure.ChangeMap(mapId, position, typeof(MonsterTestProcedure));
        }
    }
}