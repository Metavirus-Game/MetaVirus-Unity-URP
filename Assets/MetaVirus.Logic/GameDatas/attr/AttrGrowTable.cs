...
public sealed partial class AttrGrowTable :  Bright.Config.BeanBase 
{
    public AttrGrowTable(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static AttrGrowTable DeserializeAttrGrowTable(ByteBuf _buf)
    {
        return new attr.AttrGrowTable(_buf);
    }
    ...
    public const int __ID__ = 1156760365;
