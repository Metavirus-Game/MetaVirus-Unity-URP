...
public class UIJoystickController
{
    ...
    //private int[] _cameraAngles = { -35, -45, -90 };

    private readonly Vector2 _joystickUp = new Vector2(0, -1);

    public UIJoystickController(GComponent stageUi)
    {
        _eventService = GameFramework.GetService<EventService>();

        var touchArea = stageUi.GetChild("TouchArea").asButton;
        ...
        var joystick = stageUi.GetChild("Joystick").asCom;
        ...
        _btnCamera = stageUi.GetChild("n2").asButton;
    ...
    private void OnJoystickAreaTouched(EventContext context)
    {
        ...
        switch (context.type)
        {
            ...
            case "onTouchMove":
                ...
                _eventService.Emit(GameEvents.ControllerEvent.JoystickEvent,
                    new JoystickEvent(JoystickEvent.JoystickEventType.Moving, sub));
            ...
            case "onTouchEnd":
                ...
                _eventService.Emit(GameEvents.ControllerEvent.JoystickEvent,
                    new JoystickEvent(JoystickEvent.JoystickEventType.Stopped, _joystickPos));
